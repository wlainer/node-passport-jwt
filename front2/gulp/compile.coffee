...
gulp.task 'injector', ->
  target = gulp.src "#{paths.publicDir}/index.html"
  sources = gulp.src ["#{paths.publicDirCSS}/**/*", "#{paths.publicDirJS}/**/*.js"], {read: false}
...
gulp.task 'removeHTML', ->
  gulp.src ["#{paths.publicDir}/index.html", "#{paths.publicDir}/app/"]
    .pipe plgn.rimraf()
...
gulp.task 'compile', ['removePublic', 'jade', 'stylus']
